...
const NAV = [
  ...
  { href: '/oracle', label: 'Oracle', icon: (<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="currentColor" strokeWidth="1.2"/><circle cx="8" cy="8" r="2" stroke="currentColor" strokeWidth="1.2"/><path d="M8 2v2M8 12v2M2 8h2M12 8h2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>) },n  { href: '/calculator', label: 
{ href: '/oracle', label: 'Oracle', icon: (<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="currentColor" strokeWidth="1.2"/><circle cx="8" cy="8" r="2" stroke="currentColor" strokeWidth="1.2"/><path d="M8 2v2M8 12v2M2 8h2M12 8h2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>) },'Revenue Gap', icon: (<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path d="M2 12h2M6 8h2M10 5h2M14 2h2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/><path d="M2 14V12M6 14V8M10 14V5M14 14V2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>) },
