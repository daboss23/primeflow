...
const KPIS = [
  {
    ...
    value:  '$49,560',
    sub:    'across all active workflows',
    color:  '#00e676',
    icon: (
  ...
  return (
    <div className="flex-1 overflow-y-auto h-full" style={{ background: '#070714' }}>
      <div className="px-8 py-9">
        ...
        {/* ── Top 3 Campaigns + Recovery Sources ── */}
        <div className="grid grid-cols-[1fr_380px] gap-5 mb-6">
          ...
          <div className="rounded-2xl p-6"
            ...
            <div className="text-[10px] font-semibold tracking-[0.14em] uppercase mb-5"
              ...
              Top 3 High-Performing Campaigns
            </div>
                ...
                return (
                  <div key={c.name} className="p-4 rounded-xl"
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        { label: 'Enrolled',   value: c.enrolled,                          color: 'rgba(255,255,255,0.65)' },
                        ...
                        <div key={label} className="px-3 py-2 rounded-lg"
                          ...
                          <div className="text-[13px] font-bold" style={{ color, fontFamily: 'var(--font-jetbrains)' }}>
                            {value}
                          </div>
                        </div>
                      ))}
                ...
                <div key={label}>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] w-7 text-right" style={{ color: 'rgba(255,255,255,0.3)' }}>
                        {pct}%
                      </span>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-4 gap-4">
            {SEGMENT_PERFORMANCE.map(({ label, rate, color, revenue }) => (
              <div key={label} className="p-4 rounded-xl"
                ...
                <div className="text-[28px] font-bold mb-0.5" style={{ color, fontFamily: 'var(--font-jetbrains)' }}>
                  {rate}%
                </div>
                <div className="text-[10px] mb-2.5" style={{ color: 'rgba(255,255,255,0.28)' }}>conversion rate</div>
                <div className="h-[3px] rounded-full overflow-hidden mb-2.5"
                  style={{ background: 'rgba(255,255,255,0.06)' }}>
                  <div className="h-full rounded-full score-bar-fill"
